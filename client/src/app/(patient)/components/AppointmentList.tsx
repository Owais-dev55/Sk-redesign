            ...
            <div className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-6 flex flex-col items-start sm:items-end">
                 ...
                 {isUpcoming === true && appointment.status.trim().toLowerCase() === "upcoming" && (   <div className="mt-3 space-y-3">
                      ...
                      <div className="pt-2 border-t border-gray-100">
                        <div className="flex items-center justify-between gap-5">
                          ...
                          >
                            <PiChatCircleDuotone className="w-4 h-4" /> Start Chat
                          </button>
                        </div>
                      </div>
                    </div>
